...
<ins>Grazing</ins>
- Graze (25-101) points or greater on a random Easy or Normal spell card as a random team
- Graze (25-101) points or greater on a random Hard or Lunatic spell card as a random team (Difficult)
- Graze (25-101) points or greater on a random Extra spell card as a random team (Difficult)

<ins>Team specific Grazing</ins>
- Graze (25-101) times or greater on a random Satori spell card as a Reimu A on a random difficulty
- Graze (25-101) times or greater on a random Satori spell card as a Reimu B on a random difficulty
- Graze (25-101) times or greater on a random Satori spell card as a Reimu C on a random difficulty
- Graze (25-101) times or greater on a random Satori spell card as a Marisa A on a random difficulty
- Graze (25-101) times or greater on a random Satori spell card as a Marisa B on a random difficulty
- Graze (25-101) times or greater on a random Satori spell card as a Marisa C on a random difficulty
...
- Score (1000-650001) points or greater on a random Easy, Normal, or Hard spell card on Normal as a random character
- Score (1000-650001) points or greater on a random Easy, Normal, or Hard spell card on Hard as a random character (Difficult)
- Score (1000-650001) points or greater on a random Hard or Lunatic spell card on Hard as a random character (Difficult)
- Score (1000-650001) points or greater on a random Hard or Lunatic spell card on Lunatic as a random character (Difficult)
- Score (1000-650001) points or greater on a random Hard spell card as a random character (Difficult)
- Score (1000-650001) points or greater on a random Lunatic spell card as a random character (Difficult)
- Score (1000-650001) points or greater on a random Extra spell card as a random character (Difficult)
- Score (1000-650001) points or greater on a random spell card on Easy as a random character
- Score (1000-650001) points or greater on a random spell card on Normal as a random character
...
- Graze (25-101) times or greater on a random Easy, Normal, or Hard spell card on Normal as a random character
- Graze (25-101) times or greater on a random Easy, Normal, or Hard spell card on Hard as a random character (Difficult)
- Graze (25-101) times or greater on a random Hard or Lunatic spell card on Hard as a random character (Difficult)
- Graze (25-101) times or greater on a random Hard or Lunatic spell card on Lunatic as a random character (Difficult)
- Graze (25-101) times or greater on a random Hard spell card as a random character
- Graze (25-101) times or greater on a random Lunatic spell card as a random character
- Graze (25-101) times or greater on a random Extra spell card as a random character
- Graze (25-101) times or greater on a random spell card on Easy as a random character
- Graze (25-101) times or greater on a random spell card on Normal as a random character
