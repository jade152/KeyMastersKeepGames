...
class SleeperHuntGame(Game):
    ...
    def game_objective_templates(self) -> List[GameObjectiveTemplate]:
        return[
            ...
            GameObjectiveTemplate(
                label="Hijack a sleeper that has a AFFINITY affinity to ELEMENT",
                data={
            ...
            GameObjectiveTemplate(
                label="Hijack a sleeper that has a AFFINITY affinity to Physical",
                data={
            ...
            GameObjectiveTemplate(
                label="Hijack a sleeper that has a AFFINITY affinity to Electric",
                data={
            ...
            GameObjectiveTemplate(
                label="Fuse sleepers to make a sleeper that has a AFFINITY affinity to ELEMENT",
                data={
                    "AFFINITY": (self.elements_affinities, 1),
                    "ELEMENT":  (self.elements, 1)
                },  
            ...
            GameObjectiveTemplate(
                label="Fuse sleepers to make a sleeper that has a AFFINITY affinity to Physical",
                data={
                    "AFFINITY": (self.element_physical_affinities, 1),
                },  
                is_time_consuming=False,
            ...
            GameObjectiveTemplate(
                label="Fuse sleepers to make a sleeper that has a AFFINITY affinity to Electric",
                data={
                    "AFFINITY": (self.element_electric_affinities, 1),
                },  
                is_time_consuming=False,
