     ...
     def game_objective_templates(self) -> List[GameObjectiveTemplate]:
         templates: List[GameObjectiveTemplate] = [
             GameObjectiveTemplate(
                ...
                GameObjectiveTemplate(
                label="Win a Free For All game against COUNT Bots(s) on SKILL in MAP against the following character: CHARACTERS",
                data={
                    "COUNT": (self.bot_count_range, 1),
                    "SKILL": (self.skill_levels, 1),
                    "MAP": (self.maps_deathmatch, 1),
                ...
                GameObjectiveTemplate(
                label="Win a Team Deathmatch game against COUNT Bots(s) on SKILL in MAP against the following character: CHARACTERS",
                data={
                    "COUNT": (self.bot_count_range, 1),
                    "SKILL": (self.skill_levels, 1),
                    "MAP": (self.maps_team_deathmatch, 1),
                ...
                GameObjectiveTemplate(
                label="Win a Tournament game against COUNT Bots(s) on SKILL in MAP against the following character: CHARACTERS",
                data={
                    "COUNT": (self.bot_count_range, 1),
                    "SKILL": (self.skill_levels, 1),
                    "MAP": (self.maps_tournament, 1),
                ...
                GameObjectiveTemplate(
                label="Win a Capture The Flag game against COUNT Bots(s) on SKILL in MAP against the following character: CHARACTERS",
                data={
                    "COUNT": (self.bot_count_range, 1),
                    "SKILL": (self.skill_levels, 1),
                    "MAP": (self.maps_tournament, 1),
